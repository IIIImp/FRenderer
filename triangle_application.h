...
#define GLFW_INCLUDE_VULKAN  // GLFW will include Vulkan automatically
...
private:
	GLFWwindow* window;
	VkInstance instance;     // Store the Vulkan instance
